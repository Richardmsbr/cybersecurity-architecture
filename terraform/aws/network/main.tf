...
# VPC, Security Groups, NACLs, and Network Firewall
...
resource "aws_default_security_group" "default" {
  ...
  tags = {
    ...
    Environment = var.environment
    ManagedBy   = "terraform"
    Warning     = "Do not use - restricted by design"
  }
}
...
resource "aws_security_group" "bastion" {
  ...
  ingress {
    ...
    to_port     = 22
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"]  # Replace with actual trusted IPs
  }
...
# Network ACL - Database Subnets (Isolated)
